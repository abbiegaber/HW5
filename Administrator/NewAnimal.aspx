<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="NewAnimal.aspx.vb" Inherits="Default2" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <h1> Adoptable Animals</h1>
        <br />
               You can add an animal to the online database by filling in the following 
        information.<br />
        ...
        <asp:DetailsView ID="DetailsView1" runat="server" AutoGenerateRows="False" 
            ...
            Width="434px" DefaultMode="Insert">
            <Fields>
                <asp:BoundField DataField="AnimalID" HeaderText="AnimalID" 
